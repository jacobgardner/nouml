...
export function isSubdoc(
  model: HierarchyNode<CollectionSchema>
): model is HierarchyNode<SubdocFieldItem> {
  return !!(model as any).children;
}

export function isStandaloneItem(
  model: HierarchyNode<CollectionSchema>
): model is HierarchyNode<StandaloneFieldItem> {
  return !(model as any).children;
}
  ...
  children: [
    {
      ...
      type: 'ObjectId',
      notes:
        'This _id is autogenerated by Mongodb upon insertion. More notes here blah blah blah blah',
    },
